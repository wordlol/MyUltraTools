...
//Связность это логика связки елементов в данном классе или методе
//Связанность это то на сколько сильно данный метод или класс зависит от другого элемента
